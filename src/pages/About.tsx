        ...
        <Container maxWidth="md">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              ...
              >
                A journey of passion, flavor, and community in the heart of Oshawa
              </Typography>
            </motion.div>
          </motion.div>
        </Container>
                ...
                <motion.div variants={staggerContainer}>
                  ...
                  <motion.div variants={fadeInUp}>
                    <Typography variant="h2" sx={{ mb: 4 }}>
                      From Dream to
                      <Box component="span" sx={{ color: 'primary.main' }}> Reality</Box>
                    </Typography>
                  </motion.div>
                  <motion.div variants={fadeInUp}>
                    <Typography
                    ...
                    >
                      The Rolling Barrel was born from a simple dream: to create a place where 
                      exceptional food meets genuine hospitality. Nestled in the vibrant community 
                      of Oshawa, we've built more than just a restaurant – we've created a home 
                      away from home.
                    </Typography>
                  </motion.div>
                  <motion.div variants={fadeInUp}>
                    <Typography
                      ...
                      sx={{ mb: 3, color: 'text.secondary', lineHeight: 1.9 }}
                    >
                      Our name reflects our philosophy: like a barrel that rolls forward, we're 
                      constantly evolving, experimenting with new flavors while honoring traditional 
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    >
                      Every dish we serve tells a story – of fresh ingredients sourced from local 
                      farms, of recipes perfected over time, and of the love and care that goes 
                      into every plate that leaves our kitchen.
                    </Typography>
                  </motion.div>
                </motion.div>
              </Grid>
          ...
          >
            <Box sx={{ textAlign: 'center' }}>
              ...
              <motion.div variants={fadeInUp}>
                ...
                >
                  Behind every great meal is a team of dedicated individuals who pour their 
                  hearts into creating unforgettable experiences. From our talented chefs to 
                  our warm and welcoming staff, everyone at The Rolling Barrel shares a common 
                  goal: to make your visit truly special.
                </Typography>
              </motion.div>
              <motion.div variants={fadeInUp}>
                <Box
                ...
                >
                  <Typography variant="h4" sx={{ fontStyle: 'italic', mb: 2 }}>
                    "Food is our love language, and every dish is a letter to your soul."
                  </Typography>
        ...
        <Container maxWidth="sm">
          ...
          >
            <Typography variant="h3" sx={{ mb: 3 }}>
              Ready to Experience
              <Box component="span" sx={{ color: 'primary.main' }}> The Difference?</Box>
            </Typography>
